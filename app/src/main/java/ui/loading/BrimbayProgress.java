...
public class BrimbayProgress {
    ...
    public BrimbayProgress(Context context) {
        mContext = context;
        mProgressDialog = new ProgressDialog(context);
        mDimAmount = 0;
        mWindowColor = context.getResources().getColor(R.color.brimbay_progress_default_color, null);
        mAnimateSpeed = 1;
        mCornerRadius = 16;
        mIsAutoDismiss = true;
        mGraceTimeMs = 0;
     ...
     */
    public static BrimbayProgress create(Context context) {
        return new BrimbayProgress(context);
    }

    /**
     * Create a new HUD. specify the HUD style (if you use a custom view, you need {@code DirectPesaProgress.create(Context context)}).
     *
     * @param context Activity context that the HUD bound to
     * @param style   One of the DirectPesaProgress.Style values
     * @return An unique HUD instance
     */
    public static BrimbayProgress create(Context context, Style style) {
        return new BrimbayProgress(context).setStyle(style);
    }
     ...
     * @return Current HUD
     */
    public BrimbayProgress setStyle(Style style) {
        View view = null;
        switch (style) {
     ...
     * @return Current HUD
     */
    public BrimbayProgress setDimAmount(float dimAmount) {
     ...
     * @return Current HUD
     */
    public BrimbayProgress setSize(int width, int height) {
     ...
     * @return Current HUD
     */
    public BrimbayProgress setWidth(int width) {
        mProgressDialog.setWidth(width);
        return this;
    }
     ...
     */
    @Deprecated
    public BrimbayProgress setWindowColor(int color) {
        mWindowColor = color;
        return this;
    }
     ...
     * @return Current HUD
     */
    public BrimbayProgress setBackgroundColor(int color) {
        mWindowColor = color;
        return this;
    }
     ...
     * @return Current HUD
     */
    public BrimbayProgress setCornerRadius(float radius) {
     ...
     * @return Current HUD
     */
    public BrimbayProgress setAnimationSpeed(int scale) {
        mAnimateSpeed = scale;
        return this;
    }
     ...
     * @return Current HUD
     */
    public BrimbayProgress setLabel(String label) {
     ...
     * @return Current HUD
     */
    public BrimbayProgress setLabel(String label, int color) {
     ...
     * @return Current HUD
     */
    public BrimbayProgress setDetailsLabel(String detailsLabel) {
     ...
     * @return Current HUD
     */
    public BrimbayProgress setDetailsLabel(String detailsLabel, int color) {
     ...
     * @return Current HUD
     */
    public BrimbayProgress setMaxProgress(int maxProgress) {
     ...
     * @return Current HUD
     */
    public BrimbayProgress setCustomView(View view) {
        if (view != null) {
            mProgressDialog.setView(view);
        } else {
     ...
     * @return Current HUD
     */
    public BrimbayProgress setCancellable(boolean isCancellable) {
     ...
     * @return Current HUD
     */
    public BrimbayProgress setCancellable(DialogInterface.OnCancelListener listener) {
     ...
     * @return Current HUD
     */
    public BrimbayProgress setAutoDismiss(boolean isAutoDismiss) {
     ...
     * @return Current HUD
     */
    public BrimbayProgress setGraceTime(int graceTimeMs) {
        mGraceTimeMs = graceTimeMs;
        return this;
    }

    public BrimbayProgress show() {
        if (!isShowing()) {
            mFinished = false;
            if (mGraceTimeMs == 0) {
    ...
    private class ProgressDialog extends Dialog {
        ...
        private BrimbayBackgroundLayout mBrimbayBackgroundLayout;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.brimbay_progress_view);
        ...
        private void initViews() {
            mBrimbayBackgroundLayout = findViewById(R.id.background);
            mBrimbayBackgroundLayout.setBaseColor(mWindowColor);
            mBrimbayBackgroundLayout.setCornerRadius(mCornerRadius);
            if (mWidth != 0) {
        ...
        private void updateBackgroundSize() {
            ViewGroup.LayoutParams params = mBrimbayBackgroundLayout.getLayoutParams();
            params.width = Helper.dpToPixel(mWidth, getContext());
            params.height = Helper.dpToPixel(mHeight, getContext());
            mBrimbayBackgroundLayout.setLayoutParams(params);
        }
        ...
        public void setSize(int width, int height) {
            mWidth = width;
            mHeight = height;
            if (mBrimbayBackgroundLayout != null) {
                updateBackgroundSize();
            }
        }
